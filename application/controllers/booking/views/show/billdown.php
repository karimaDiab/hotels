  ...
  <div class="row">
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">      تسكيل اقل من 35 </h3>
               ...
               <th style="width: 40px"></th>
                ...
                <tr>
                  ...
                  <td><?= $row['name']; ?> </td>
                      ...
                      <td style="width: 40%"><?=$row['comment8'] ?><br><?=$row['comment7'] ?> </td>
   ...
   <?php for($count=1;$count<$pages;$count++):?>
                <li><a href="<?= base_url('booking/'.$this->thispage.'/billdown/'.$count); ?>"><?=$count?></a></li>
