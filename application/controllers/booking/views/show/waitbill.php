...
<div  style="float:right"><div  style="margin-left:10px"><a href="<?= base_url()?>/booking/<?=$this->thispage?>/waitbill/1/finsh/" class="btn btn-block btn-success"  style="margin-bottom:5px"><i class="icon-pencil  icon-white"> </i>   تم الاسترجاع </a> 	</div>
...
<div class="row">
              ...
              <div class="col-sm-3 border-right   border-bottom">
                ...
                <div class="col-sm-3 border-right   border-bottom">
                  <div class="description-block">
                    ...
                    <span class="description-text"> حركات</span>
                  </div>
                  <!-- /.description-block -->
                </div>
  ...
  <div class="row">
   ...
   <?php for($count=1;$count<$pages;$count++):?>
                <li><a href="<?= base_url('booking/'.$this->thispage.'/waitbill/'.$count); ?>"><?=$count?></a></li>
