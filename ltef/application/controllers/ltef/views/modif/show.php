...
<section class="content-header">
    ...
    <div class="row">
        ...
        <div  style="float:left"><div  style="margin-left:10px"><a href="<?= base_url() ?>/ltef/modif/salary/<?=$this->thismon?>/<?= $show['text21'] ?>/<?= $show['id'] ?>" class="btn btn-block btn-primary"  style="margin-bottom:5px"  target="_black"><i class="icon-pencil  icon-white"> </i>  طباعة الراتب</a> 	</div>



        </div>
        <div  style="float:left"><div  style="margin-left:10px"><a href="<?= base_url() ?>/ltef/modif/kshaf/<?=$this->thismon?>/<?= $show['text21'] ?>/<?= $show['id'] ?>" class="btn btn-block btn-primary"  style="margin-bottom:5px"  target="_black"><i class="icon-pencil  icon-white"> </i>  طباعة التحضير</a> 	</div>



        </div>
    <div  style="float:left"><div  style="margin-left:10px"> <a href="<?= base_url('ltef/'.$this->thispage.'/addsalf/'.$show['id'])?>" class="btn btn-block btn-danger"  style="margin-bottom:5px"><i class="icon-pencil  icon-white"> </i>     سلفة </a>
             </div>   </div>     
