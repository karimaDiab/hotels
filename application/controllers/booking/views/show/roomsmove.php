        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"> حركات النقل   </h3>
            ...
            <div class="box-body" style="">
              <table class="table table-bordered">
                <tr>
                  ...
                  <th>الدخول</th> 
                  <th>وقت النقل</th>    
                    <th style="width: 40px">الساعات</th>
                ...
                <tr>
                  ...
                  <td><?= $row['name']; ?> </td>
                      ...
                      <td><?= $this->booking->tissme_show($row['timeenter']); ?> </td>
                        ...
                        <td><?= $this->booking->tissme_show($row['timemove']); ?> </td> 
                        
                        <td><?=               round(((($row['timeenter'] - $row['timemove']) / 60) / 60), 0)
 ?> </td>
   ...
   <?php for($count=1;$count<$pages;$count++):?>
                <li><a href="<?= base_url('booking/'.$this->thispage.'/roomsmove/'.$count); ?>"><?=$count?></a></li>
