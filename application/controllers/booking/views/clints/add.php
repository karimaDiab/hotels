           ...
           <?php echo form_open_multipart(base_url('booking/'.$thispage.'/add/')); ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder=" الجنسية " name="country" >
                </div>
                 <div class="form-group">
                      <label>النوع</label>
                  <div class="radio">
                
                      <input type="radio" name="oky"  value=""  checked="">
                <label>       عادي
                    </label>
                  </div>
                  <div class="radio">
                  
                      <input type="radio" name="oky"  value="star">
                <label>   مميز
                    </label>
                  </div>
                      ...
                      <input type="radio" name="oky"  value="ok">
                 <label>    بلاك لست
                    </label>
                  </div>
                    ...
                    <div class="form-group">
                  <label>وصف</label>
                  <textarea class="form-control" rows="3" placeholder="وصف ..." name="comment"></textarea>
                </div>
                     <div class="form-group">
