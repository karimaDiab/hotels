    ...
    $("#editor").cleditor(); 
	 $("#inbox-editor").cleditor({
		width:        99+'%', // width not including margins, borders or padding
     	 ...
     	 $("#inbox-editor0").cleditor({
		width:        99+'%', // width not including margins, borders or padding
          height:       500, // height not including margins, borders or padding 
	 });
     	 $("#inbox-editor1").cleditor({
		width:        99+'%', // width not including margins, borders or padding
          height:       500, // height not including margins, borders or padding 
	 }); /*== make code pretty ==*/
     	 $("#inbox-editor2").cleditor({
		width:        99+'%', // width not including margins, borders or padding
          height:       500, // height not including margins, borders or padding 
	 }); /*== make code pretty ==*/
     	 $("#inbox-editor3").cleditor({
		width:        99+'%', // width not including margins, borders or padding
          height:       500, // height not including margins, borders or padding 
	 }); /*== make code pretty ==*/
     	 $("#inbox-editor4").cleditor({
		width:        99+'%', // width not including margins, borders or padding
          height:       500, // height not including margins, borders or padding 
	 }); /*== make code pretty ==*/
     	 $("#inbox-editor5").cleditor({
		width:        99+'%', // width not including margins, borders or padding
          height:       500, // height not including margins, borders or padding 
	 }); /*== make code pretty ==*/
     	 $("#inbox-editor6").cleditor({
		width:        99+'%', // width not including margins, borders or padding
          height:       500, // height not including margins, borders or padding 
	 }); /*== make code pretty ==*/	 
     $("#inbox-editor7").cleditor({
		width:        99+'%', // width not including margins, borders or padding
          height:       500, // height not including margins, borders or padding 
	 }); /*== make code pretty ==*/                              
	 	 $("#inbox-editor8").cleditor({
		width:        99+'%', // width not including margins, borders or padding
          height:       500, // height not including margins, borders or padding 
	 }); /*== make code pretty ==*/
     	 $("#inbox-editor9").cleditor({
		width:        99+'%', // width not including margins, borders or padding
          height:       500, // height not including margins, borders or padding 
	 }); /*== make code pretty ==*/
     	 $("#inbox-editor10").cleditor({
		width:        99+'%', // width not including margins, borders or padding
          height:       500, // height not including margins, borders or padding 
	 }); /*== make code pretty ==*/
     	 $("#inbox-editor11").cleditor({
		width:        99+'%', // width not including margins, borders or padding
          height:       500, // height not including margins, borders or padding 
	 }); /*== make code pretty ==*/               
	...
	$(function()
	{
		...
		$(function()
		{
			$('.theme-color').click(function()
			{
				...
				$('#themes').attr('href','style/css'+'/'+stylesheet+'.css');
				});
			});