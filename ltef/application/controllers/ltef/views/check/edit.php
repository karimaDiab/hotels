<section class="content-header">
    ...
    <ol class="breadcrumb" style="right: 10px;">
        ...
        <li><a href="<?=base_url('ltef/'.$thispage.'/')?>">الفواتير</a></li>
      </ol>
    </section>
      ...
      <div class="box-body">
              ...
              <div class="form-group">
                  <label>الشيك باسم</label>
                               <input type="text" class="form-control"  placeholder="  الشيك باسم " name="text2" value="<?=$edit['text2']?>">
              ...
              <div class="form-group">
                  <label> رقم الشيك</label>
                               <input type="text" class="form-control"  placeholder="  رقم الشيك " name="text3" value="<?=$edit['text3']?>">
                  ...
                  <input type="text" class="form-control"  placeholder="  المستلم " name="text11" value="<?=$edit['text11']?>">
                </div>  
                  <div class="form-group">
                  <label for="exampleInputPassword1">     وذلك عن 	</label>
                  <input type="text" class="form-control"  placeholder="  الى " name="text12" value="<?=$edit['text12']?>">
                </div>
                  ...
                  <input type="number" class="form-control"  placeholder="  الهاتف " name="text13" value="<?=$edit['text13']?>">
                </div>
               
                  <div class="form-group">
                  <label for="exampleInputPassword1">   تاريخ الاستحقاق 	</label>
               
                  <input type="text" class="form-control"  id="datepicker" placeholder="  المستلم " data-date-format="yyyymmdd"  name="dateadd" value="<?=$edit['dateadd']?>">
        	      	      	...
        	      	      	<input type="radio"  required   value="7"  name="text30"  <?php if($edit['text30']==7)echo "checked"?>>الرقعي &nbsp; &nbsp;&nbsp; &nbsp;
                                    	<input type="radio"   required  value="8"  name="text30"  <?php if($edit['text30']==8)echo "checked"?>>الشعب &nbsp; &nbsp;&nbsp; &nbsp;
                                        	<input type="radio"   required  value="9"  name="text30"  <?php if($edit['text30']==9)echo "checked"?>>ريحانه &nbsp; &nbsp;&nbsp; &nbsp;
            	                         	<input type="radio"   required  value="11"  name="text30"  <?php if($edit['text30']==11)echo "checked"?>>الفنطاس &nbsp; &nbsp;&nbsp; &nbsp;
