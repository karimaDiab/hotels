...
<div  style="float:right"><div  style="margin-left:10px"><a href="<?= base_url()?>/booking/checkroom/add/" class="btn btn-block btn-primary"  style="margin-bottom:5px"><i class="icon-pencil  icon-white"> </i> اضافة طلب صيانة</a> 	</div>
            ...
            <div  style="float:right"><div  style="margin-left:10px"><a href="<?= base_url()?>/booking/checkroom/all/1/" class="btn btn-block btn-primary"  style="margin-bottom:5px"><i class="icon-pencil  icon-white"> </i>  الطلبات الحالية</a> 	</div>
  ...
  <div class="row">
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-md-12">
                  ...
                  <th>المكان</th>
                   <th> المطلوب</th>
                    ...
                    <th>الملاحظة</th>
                       <th>السبب</th>
                       <th> التاريخ</th>
                  <th style="width: 40px">الانتهاء</th>
          ...
          <td><?= $this->booking->tissme_show($row['text6']); ?></td>
   ...
   <?php for($count=1;$count<$all_count;$count++):?>
                <li><a href="<?= base_url('booking/'.$this->thispage.'/arshif/'.$count); ?>"><?=$count?></a></li>
