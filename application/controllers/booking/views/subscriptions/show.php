...
<section class="content-header">
    ...
    <ol class="breadcrumb" style="right: 10px;">
        ...
        <li><a href="<?= base_url('booking/subscriptions/') ?>"> الباقات</a></li>
    </ol>
</section>
...
<div class="row">
  ...
  <?php if ($show['counter'] == '1'  or $show['counter'] == '3' ): ?>
        <br>
        <a title="Edit" class="update btn btn-sm btn-primary pull-right" href="<?= base_url('booking/' . $this->thispage . '/change/' . $show['id']) ?>"><i class="material-icons">نقل الارشيف </i></a>
        
             <br>     <br>     <br>
   <?php endif; ?>
                      <?php if ($show['counter'] == '1' ): ?>
          <div class="box">    
         <?php echo form_open_multipart(base_url('booking/'.$thispage.'/oky/'.$show['id'])); ?>
              <div class="box-body">
               <div class="box-header with-border">
