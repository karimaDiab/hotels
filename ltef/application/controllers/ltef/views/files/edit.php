...
<div class="row">
 ...
 <div class="form-group">
                    <label >   القسم 	</label>
                    <input type="text" class="form-control"  placeholder="   " name="text1" value="<?=$edit['text1']?>"> <br> مثل بشير سالم - السالمية
                </div>
          
               <div class="form-group">
                    <label >  نوع	</label>
                    <input type="text" class="form-control"  placeholder="   " name="text2" value="<?=$edit['text2']?>"><br>    مثل  : بطاقة مدنية - عقد ايجار
                </div>
                  <div class="form-group">
                    <label >   ملاحظات	</label>
                  ...
                  <input id="dateTimeFlatpickr" name="datetext4" value="<?=$edit['dateadd']?>" class="form-control flatpickr flatpickr-input " type="number" placeholder="Select Date.."><br>
