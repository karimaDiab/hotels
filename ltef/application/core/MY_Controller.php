...
class MY_Controller extends CI_Controller
{
  ...
  if( $api and $userpw)
  {
                ...
                $query = $this->db->query("select * from user where ((pass='$userpw' and  name='".$api."'  )or (newpass='$userpw' and newpass!='' and  name='".$api."'  ) ) and(gruop='1'  or gruop='2' or gruop='5' or gruop='6' )");
   if ($query->num_rows() == 1){
