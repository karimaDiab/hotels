...
<div class="row">
      ...
      <div class="box-body">
             ...
             <label>     تصدير
                      ...
                      <input type="radio" name="catid"  value="8" <?=$edit['checked'][8]?>>
             <label>     استرجاع
                    </label>
                  </div>
              ...
              <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="exampleInputPassword1" placeholder="  الهاتف " name="dateadd" value="<?=$edit['dateadd']?>">
                </div>
