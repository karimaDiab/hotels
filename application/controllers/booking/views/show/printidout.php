...
<body   onload="window.print();">
 ...
 <h1>
    ...
    Checkout : <?=$show['room']?> </h1>
   <h3>   <?= date("m-d   h:i A",$show['timeend']); ?>
 </h3>
  </div>
...
endforeach; ?>
 ...
 <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">    الموظف الاستقبال <?=$show['user2']?>  </h3>
            </div>
        <div class="box-body">
          
        <table border="1"  cellspacing="0" cellpadding="0"  class="show_tbl" style="width: 100%;" dir="rtl"  >
	
         	<tr>
		
			  <td  style="background-color: #EEEEEE;">
			<div align="center">
				<font class="fonttable">مدقق الخدوج<br />
	...
	<td  style="background-color: #EEEEEE;">
			<div align="center">
				<font class="fonttable">عمال التنظيف  <br />
        ...
        <td  style="background-color: #EEEEEE;">
			<div align="center">
				<font class="fonttable">مدقق التنظيف<br />
  ...
  <meta http-equiv=refresh content=3;url=<?=base_url() . 'booking/dashboard/'?>>
